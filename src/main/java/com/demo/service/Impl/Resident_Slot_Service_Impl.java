...
public class Resident_Slot_Service_Impl implements Resident_Slot_Service {
    ...
    @Override
    public String save(Resident_Slot_DTO dto) {
        Resident_Slot resident_slot = new Resident_Slot(dto.getId_R_Slot(), dto.getType_Of_Vehicle(), dto.isStatus_Slots(), areaRepository.findById(dto.getId_Area()).get());
